Install a "thermo-nuclear code quality review" skill + subagent into this repo, verbatim as specified below. Create exactly these two files with exactly the content given (do not paraphrase, reword, or "improve" the content). Create parent directories as needed. Do not add any other files. After creating them, if this repo keeps Claude and Codex agent configs in sync via a sync script (e.g. a `make sync-agent-config` target or `scripts/sync_agent_config.py`), run it; otherwise skip that step.

============================================================
FILE 1 — path: .claude/agents/thermo-nuclear-code-quality-review.md
============================================================
---
...
============================================================
FILE 2 — path: .claude/skills/thermo-nuclear-code-quality-review/SKILL.md
============================================================
---
name: thermo-nuclear-code-quality-review
...
After creating both files, confirm the two paths exist and report done. The skill is user-invocable as `/thermo-nuclear-code-quality-review`; the subagent is invocable via the Task tool with subagent_type "thermo-nuclear-code-quality-review".
